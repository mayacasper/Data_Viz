...
medexam<-read.csv(here('MedicalExaminerTableau_2020_05_Migrated Data.csv'))

overall_rate3<- read.csv(here('2019-2023.csv'))

map <- st_read(here('counties 2/counties.shp'))
